...
final class MooEncoderTests: XCTestCase {
    ...
    func testEncodingSuccessfully() {
        ...
        let messages: [MooMessage] = [
            ...
            MooMessage(requestID: 1, verb: SwiftRoonAPI.MooVerb.request, name: .register, headers: [SwiftRoonAPI.MooHeaderName.contentType: .applicationJson], body: try! RoonExtensionRegInfo.makeEncoded()),
